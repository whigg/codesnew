...
%%%delete 'D:\aqua\results\res1.xlsx';
...
%%%xlswrite('D:\aqua\results\res1.xlsx',Target_ID(:,1),'Sheet1','A2');
fig=scatter((Area_and_altimetry(:,1)),(Area_and_altimetry(:,2)))
fname = 'D:\aqua\results';
saveas(gca,'D:\aqua\results\fig','jpeg');
% saveas(fig, sprintf('FIG.jpg'))

% saveas(gca,'D:\aqua\results\f','jpeg')