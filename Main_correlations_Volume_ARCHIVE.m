...
dlmwrite('D:\aqua\results\Hypsometry_612_DAHITI.txt',VolData,'delimiter','\t','precision',3);
dlmwrite('D:\aqua\results\DiffData_612_DAHITI.txt',VolData,'delimiter','\t','precision',3);
dlmwrite('D:\aqua\results\VolumeEst_612_DAHITI.txt',Vol_est,'delimiter','\t','precision',3);
fig_Corr=scatter((Area_and_altimetry(:,1)),(Area_and_altimetry(:,2))); xlabel ('Area'); ylabel ('Altimetry');
saveas(gca,'D:\aqua\results\fig_Corr_612_DAHITI','fig');
saveas(gca,'D:\aqua\results\fig_Corr_612_DAHITI','jpeg');
fig_Vol=plot((VolData(:,1)),DDv2(:,2)-min(DDv2(:,2)));xlabel ('Time'); ylabel ('Est Volume');
saveas(gca,'D:\aqua\results\fig_Vol_612_DAHITI','fig');
saveas(gca,'D:\aqua\results\fig_Vol_612_DAHITI','jpeg');